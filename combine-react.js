...
const outputFile = path.join(dir, 'React-Development-Mastering-Guide.md');
...
const files = [
    'react-01-intro.md',
    'react-02-components.md',
    'react-03-hooks.md',
    'react-04-state.md',
    'react-05-typescript.md',
    'react-06-routing-api.md',
    'react-07-performance-forms.md',
    'react-08-realworld.md',
    'react-09-production.md',
    'react-10-interview.md'
];
...
function run() {
    ...
    console.log('MD compilation completed entirely.');
}
