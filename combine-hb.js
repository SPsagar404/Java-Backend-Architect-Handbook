...
const files = ['hb-01-intro.md', 'hb-02-springdata.md', 'hb-03-advanced.md', 'hb-04-interview.md'];
...
fs.writeFileSync(path.join(dir, 'Hibernate-SpringDataJPA-Mastering-Guide.md'), combined, 'utf8');
console.log('Hibernate guide combined successfully.');
